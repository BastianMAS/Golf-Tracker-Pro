...
function displayHistory() {
    ...
    document.getElementById('historyQualityFilter').addEventListener('change', function() {
        ...
        const testFilter = document.getElementById('historyTestFilter').value;
        displayHistoryTimeline(history, quality, testFilter);
        updateTestFilterOptions(quality);
        
        // Afficher graphique d'évolution si test spécifique
        if (testFilter !== 'all') {
            displayEvolutionChart(history, testFilter);
        } else {
...
function initializeHistoryFilters(history) {
    // Compter les tests par qualité
    document.getElementById('historyTotalCount').textContent = history.length;
    
    // Remplir le dropdown des tests spécifiques
...
function displayHistoryTimeline(history, qualityFilter, testFilter) {
    ...
    filtered.forEach((test, index) => {
        ...
        quality.tests.forEach(testDef => {
            ...
            // Calculer progression si test précédent existe
...
function displayEvolutionChart(history, testKey) {
    ...
    // Filtrer les tests qui contiennent ce test spécifique
